...
| Page | What it does |
|------|-------------|
| `/` | Landing page — hero, how it works, prizes, rules, FAQ |
| `/login` | Sign in to access the dashboard |
| `/dashboard` | Live countdown, progress tracker, checklist & reel submission |
...
- **Tailwind CSS**
- **Framer Motion** (desktop animations, static on mobile)
