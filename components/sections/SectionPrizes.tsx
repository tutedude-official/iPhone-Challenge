        ...
        <Reveal direction="scale">
          <div className="relative overflow-hidden rounded-[2rem] bg-gradient-to-br from-[#f8e3a6] via-[#edc168] to-[#d99a2b] p-5 text-[#3a0f33] shadow-[0_30px_80px_-30px_rgba(231,170,58,0.7)] sm:p-8 lg:p-12">
            ...
            <div className="relative z-10 flex flex-col items-center gap-4 sm:gap-6 md:flex-row md:items-center md:justify-between">
              ...
              >
                {/* glow behind phone */}
                <div className="pointer-events-none absolute left-1/2 top-1/2 -z-10" style={{ transform: "translate(-50%, -50%)", width: "145%", height: "120%" }}>
                  <div className="iphone-glow h-full w-full rounded-full" style={{ background: "radial-gradient(ellipse at 50% 50%, rgba(255,255,255,0.65) 0%, rgba(237,193,104,0.35) 45%, transparent 72%)", filter: "blur(24px)" }} />
                </div>
                <Image
